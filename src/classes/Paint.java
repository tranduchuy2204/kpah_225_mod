...
public class Paint { 
	...
	public static void onPaint(Graphics _graphics) {
		...
		if (class_acv.q == class_acv.s) {
			...
			class_d.b.a(_graphics, "Xu: " + StringUtils.formatMoney(MainCharInfo.getCurrentCoin()), 1, xPos += 12, 0);
			...
			class_d.b.a(_graphics, "Đồ bền: " + MainCharInfo.getDoBen(), 1, xPos += 12, 0);
