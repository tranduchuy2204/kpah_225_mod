...
public final class class_abj extends class_aae {
				...
				if (!var10000) {
					...
					for (var4 = 0; var4 < var11.length; ++var4) {
						if (!var11[var4].equals("")) {
							...
							// System.out.println("add menu->" + menu);
	...
	public void movePlayer_(int var1, int var2) {
		var1 /= 16;
		var2 /= 16;
		System.out.println("classes.class_abj.movePlayer_(" + "var1:" + "int" + "=" + var1 + ", " + "var2:" + "int"
				+ "=" + var2 + ")");
		if (!class_ls.a(j + class_acv.j, k + class_acv.k, 2) && !this.a(j + class_acv.j, k + class_acv.k)) {
			...
			System.out.println("classes.class_abj.movePlayer_() can not check");
		}
	}

	public boolean checkMovePos(int var1, int var2) {
		var1 /= 16;
		var2 /= 16;
		// System.out.println(
		// "classes.class_abj.checkMovePos("
		// + "var1:" + "int" + "=" + var1 + ", "
		// + "var2:" + "int" + "=" + var2 + ")"
		// );
		if (!class_ls.a(j + class_acv.j, k + class_acv.k, 2) && !this.a(j + class_acv.j, k + class_acv.k)) {
			short[] dataMove = this.b(this.q.cK / 16, this.q.cL / 16, var1, var2);
			return dataMove != null;
		} else {
			// System.out.println("classes.class_abj.checkMovePos() can not check");
			return false;
		}
	}
	...
	private short[] b(int var1, int var2, int var3, int var4) {
		...
		if (class_yg.a(var1 << 4, var2 << 4, var3 << 4, var4 << 4) <= 16) {
			System.out.println("classes.class_abj.b() not distance");
			return null;
		} else if (this.a(var3, var4)) {
			System.out.println("classes.class_abj.b() checkMoveLitmit false");
			return null;
		} else {
			class_abj.aQ = new byte[class_ls.a][class_ls.b];
//			for (int i = 0; i < class_abj.aQ.length; i++) {
//				class_abj.aQ[i] = new byte[class_ls.b];
//			}
			aR = (byte) cG;
			aS = (byte) cC;
			var1 -= aR;
			...
			if (var1 >= 0 && var1 < aQ.length) {
				...
				while (true) {
					...
					if (var12 > 5000) {
						...
						X = 1;
						System.out.println("classes.class_abj.b()->"
								+ (new StringBuffer("Cout DAY ROI------: ")).append(var12).toString());
						return null;
					}
					...
					if (var7 == var3 && var8 == var4) {
						if (var20 >= 127) {
							System.out.println("classes.class_abj.b() var20 >= 127");
							return null;
						}
						...
						while (true) {
							...
							if (var7 == var18 && var8 == var19) {
								System.out.println(ArrayUtils.arrayToString(var22));
								return var22;
							}
					...
					if (var13 != 0) {
						System.out.println((new StringBuffer("TOI DAY ROI------: ")).append(var5).toString());
						return null;
					}
				...
				System.out.println("classes.class_abj.b() NULL ELSE");
				return null;
			}
		}
	}
