            ...
            while (this.a.b()) {
                ...
                if (this.a.g) {
                    if (b == Byte.MIN_VALUE) {
                        ...
                        final byte[] array = {this.a.a.readByte(), this.a.a.readByte(), this.a.a.readByte(), this.a.a.readByte()};
                        unsignedShort = ((class_aco.a(this.a, array[3]) & 0xFF) | (class_aco.a(this.a, array[2]) & 0xFF) << 8 | (class_aco.a(this.a, array[1]) & 0xFF) << 16 | (class_aco.a(this.a, array[0]) & 0xFF) << 24);
                    } else {
                        unsignedShort = ((class_aco.a(this.a, this.a.a.readByte()) & 0xFF) << 8 | (class_aco.a(this.a, this.a.a.readByte()) & 0xFF));
                    }
                } else {
                ...
                try {
                    if (class_abs.a == -40) {
                        ...
                        int cmd = class_abs.a;
                        if (cmd != 4 && cmd != 90 && cmd != 60 && cmd != 70 && cmd != 27 && cmd != 15 && cmd != 47 && cmd != 8 && cmd != -51 && cmd != 5 && cmd != -48 && cmd != 17 && cmd != 7) {
